...
SCHOOL_RULES = {
    'CCA': {
        ...
        'modifiers': {
            ...
            '2': r'.*2.*',
            'Make Up': r'.*Make Up.*',
            'AFLS': r'.*Assessment of Functional Living Skills.*',
            'FBA': r'.*Functional Behavior Assessment.*',
            'VBA': r'.*Verbal Behavior Mapp.*',
            'PEAK': r'.*Promoting Emergence of Advanced Knowledge.*',
            'IEP Meeting': r'.*IEP.*',
